/*  
    Modified by Gwen Nov 2019
    Look for updateDirection function
*/
...
function scrollama() {
  ...
  function getIndex(element) {
	...
	function updateDirection() {
        ...
        /* Modified by Gwen Nov 2019 to work with course main_wrapper div instead of window.pageYOffset */
        
        var mwOffset = $("#main_wrapper").offset().top;
                
        if (mwOffset > previousYOffset) { direction = 'up'; }
		else if (mwOffset < previousYOffset) { direction = 'down'; }
		previousYOffset = mwOffset;        
