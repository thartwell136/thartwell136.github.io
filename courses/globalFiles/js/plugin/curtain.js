    ...
    Plugin.prototype = {
        ...
        scrollToPosition: function (direction){
            ...
            if (direction === 'up' || direction == 'down') {                
                ...
                if (position !== null) {
                    self.scrollEl.animate({ scrollTop: position }, self.options.scrollSpeed, self.options.easing);
                }
        ...
        scrollEvent: function() {
           ...
           /*   if(self.webkit)
                ...
                self.$current.removeClass('current')
                    .addClass('hidden')
                    .next('div').addClass('current').next('div').removeClass('hidden');
        ...
        setDimensions: function(){
            ...
            this.$li.each(function(index) {
                ...
                if(cover){
                    ...
                    $self.css({minHeight: 1080, zIndex: 999-index})
        ...
        setHash: function(hash){
            // "HARD FIX"
            el = $('[href=#'+hash+']');
            el.parent().siblings('div').removeClass('active');
