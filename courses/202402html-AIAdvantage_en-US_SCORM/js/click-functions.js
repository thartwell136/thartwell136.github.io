...
// Example 4 ------------------------------------------------------------------------------------------------------
// Factory function generates timelines. Helps reduce duplicate code

function createQuoteTL(num) {    
    var popupTarget = "#popup_" + num;
    var popupX = "#popup_" + num + " .X";

    var tl = gsap.timeline();
        tl
        .from(popupTarget, {duration: 0.5, opacity: 0, display: "none"})
        .from(popupX, {duration: 0.5, opacity:0}, "label")
