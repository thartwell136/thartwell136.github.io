...
function helpTheOrphans() {
    ...
    if (courseOptions.cultureCode == "pt-BR" || courseOptions.cultureCode == "id-ID") {
...
function slickRefresh() {
    ...
    $('#slider-text .slides').slick('refresh');
    $('#slider-nav .slides').slick('refresh');
    
    //$('#slider-nav .box').css("min-height","auto");
    
    var slickHeight = $('#slider-nav .slick-slide.slick-current > div').outerHeight(true);
    $('#slider-nav .box').css("min-height",slickHeight);
